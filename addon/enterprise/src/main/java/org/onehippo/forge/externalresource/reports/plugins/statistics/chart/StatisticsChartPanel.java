...
import com.onehippo.cms7.reports.plugins.chart.ChartPlugin;
import com.onehippo.cms7.reports.plugins.chart.Cluster;
...
public class StatisticsChartPanel extends ReportPanel {
    ...
    public StatisticsChartPanel(IPluginContext context, IPluginConfig config) {
        ...
        add(JavascriptPackageResource.getHeaderContribution(ChartPlugin.class, "Hippo.Reports.Chart.js"));

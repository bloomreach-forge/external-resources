...
public class MediaMosaTest {
    ...
    public void setUp() throws Exception {
        mediaMosaService = new MediaMosaService("");
        try {
            mediaMosaService.setCredentials("", "");
    ...
    public void testAlterMethod() throws Exception {
        Map map = new HashMap();
        map.put("title", "Title Changed * 2");
        mediaMosaService.setMetadata("Yq9GJw72T3vHabPAP4HINvUw",userId,map);
    }

...
public class QuartzTest {
    ...
    public void testSchedualing() throws Exception {
        ...
        //dataMap.put("synchronizer", resourceManager);
        ...
        /*  CronTrigger cronTrigger = new CronTrigger(jobId, SYNCHRONIZATION_GROUP, "0/5 * * 1/1 * ? *");

        //org.quartz.SimpleTrigger trigger = new SimpleTrigger("test");
        ...
        System.out.println("changing to minutalroy");

        if (scheduler.getTrigger(jobId, SYNCHRONIZATION_GROUP) != null) {
            System.out.println("i exist");


            CronTrigger cronTrigger2 = new CronTrigger(jobId, SYNCHRONIZATION_GROUP, "0 * 0/1 1/1 * ? *");
            cronTrigger2.setJobName(jobId);
            cronTrigger2.setJobGroup(SYNCHRONIZATION_GROUP);

            System.out.println("name is " + jobId);
            scheduler.rescheduleJob(jobId, SYNCHRONIZATION_GROUP, cronTrigger2);
        }*/
